...
const genres = [
  {
    ...
    dbValue: "Creative",
    description:
      "Develop imaginative stories with engaging characters and plots.",
    bgColor: "bg-pink-100",
  ...
  },
  {
    ...
    dbValue: "Persuasive",
    description: "Craft compelling arguments to convince your audience.",
    bgColor: "bg-sky-100",
    borderColor: "border-sky-300",
    textColor: "text-sky-700",
    buttonHoverBg: "hover:bg-sky-200",
  }, // Changed blue to sky for better Tailwind naming
  {
    name: "Article Writing",
    dbValue: "Article",
    description: "Create informative and engaging articles on various topics.",
  ...
  },
  {
    name: "Diary Entry",
    dbValue: "Diary Entry",
    description: "Write personal reflections from a specific perspective.",
    bgColor: "bg-yellow-100",
    borderColor: "border-yellow-300",
    textColor: "text-yellow-700",
    buttonHoverBg: "hover:bg-yellow-200",
  },
  {
    name: "News Report",
    dbValue: "News Report",
    description: "Develop factual news stories with the key information.",
...
export default async function PracticePage() {
  ...
  if (!hasAccess) {
    ...
    console.log(
      `User ${user.id} denied access to /practice, redirecting to /pricing`
    );
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-10 md:mb-12">
          Select a genre to practice your writing skills. Each genre offers
          unique prompts to help you prepare for the NSW selective test.
        </p>
      </div>
