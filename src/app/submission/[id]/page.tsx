...
export default async function SubmissionDetailPage({ params }: PageProps) {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    console.error(
      "Submission Detail Page Error: Supabase URL or Anon Key missing!"
    );
    return (
    ...
    return (
      <div className="container mx-auto p-6">
        <p className="text-red-500 text-center">
          Could not load submission. It might not exist or you do not have
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 max-w-6xl">
      ...
      <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-gray-900 dark:text-white">
        Submission Review:{" "}
        {submission.prompts?.genre ? `${submission.prompts.genre} - ` : ""}
